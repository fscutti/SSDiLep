...
python ../ssdilep/scripts/merge.py --var="taulead_pt" --reg="FAKES_NUM_F1" --lab="numerator" --tag="lp" --icut="2" --input="/coepp/cephfs/mel/fscutti/ssdilep/Hist1PFFLumiPresc" --output="./" --makeplot=False --fakest="Subtraction"
python ../ssdilep/scripts/merge.py --var="taulead_pt" --reg="FAKES_DEN_F1" --lab="denominator" --tag="lp" --icut="2" --input="/coepp/cephfs/mel/fscutti/ssdilep/Hist1PFFLumiPresc" --output="./" --makeplot=False --fakest="Subtraction"
