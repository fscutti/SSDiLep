...
#python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="FAKES_NUM_F1" --lab="numerator" --tag="final" --icut="7" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistMuFF1May" --output="./" --makeplot=False --fakest="Subtraction"

#python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="FAKES_DEN_F1" --lab="numerator" --tag="final" --icut="7" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistMuFF1May" --output="./" --makeplot=False --fakest="Subtraction"

#python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="FAKES_NUM_F9" --lab="numerator" --tag="final" --icut="7" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistMuFF1May" --output="./" --makeplot=False --fakest="Subtraction"


#python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="FAKES_DEN_F1" --lab="denominator" --tag="note" --icut="7" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistMuFF1May" --output="./" --makeplot=False --fakest="Subtraction"
...
python ../ssdilep/scripts/merge.py --var="trigJetlead_pt" --reg="FAKES_NUM_F2" --lab="numerator" --tag="tm" --icut="3" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistFF1PTESTMatch" --output="./" --makeplot=True --fakest="Subtraction"
python ../ssdilep/scripts/merge.py --var="trigJetlead_pt" --reg="FAKES_DEN_F2" --lab="denominator" --tag="tm" --icut="3" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistFF1PTESTMatch" --output="./" --makeplot=True --fakest="Subtraction"
...
#python ../ssdilep/scripts/merge.py --var="mulead_pt" --reg="OSZ_TL" --lab="VR" --tag="val" --icut="7" --input="/coepp/cephfs/mel/fscutti/ssdilep/HistMuVal8Apr" --output="./" --makeplot=True --fakest="Subtraction"
