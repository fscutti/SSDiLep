...
#INPATH="/coepp/cephfs/share/atlas/MLA/SUSY3Data.v3/merged/nominal"
...
#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/data.root --sampletype="data" --samplename="data"  --minentry=0 --maxentry=2000000  #--config="sys:FF_DN" 

#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/dijet.root --sampletype="mc" --samplename="dijet" --minentry=0 --maxentry=2000000   #--config="sys:FF_DN" 
